...
class SensorConfig {
  ...
  SensorConfig._({
    ...
    _sensorTypeController = BehaviorSubject<SensorType>.seeded(sensors.first.type ?? SensorType.wideAngle);
  ...
  Future<void> setZoom(double zoom) async {
    ...
    print('[Camerawesome] Setting zoom to normalized value: $zoom');
