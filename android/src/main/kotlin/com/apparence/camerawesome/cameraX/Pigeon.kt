...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PigeonSensor {
      ...
      val zoomFactor = pigeonVar_list[3] as Double?
      return PigeonSensor(position, type, deviceId, zoomFactor)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PigeonSensorTypeDevice {
      ...
      val zoomFactor = pigeonVar_list[5] as Double?
      return PigeonSensorTypeDevice(sensorType, name, iso, flashAvailable, uid, zoomFactor)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
