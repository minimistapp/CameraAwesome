            ...
            child: Wrap(
              ...
              children: [
                if (_sensorDeviceData?.ultraWideAngle != null)
                  _SensorTypeButton(
                    zoomFactor: _sensorDeviceData!.ultraWideAngle!.zoomFactor,
                ...
                if (_sensorDeviceData?.wideAngle != null)
                  _SensorTypeButton(
                    zoomFactor: _sensorDeviceData!.wideAngle!.zoomFactor,
                ...
                if (_sensorDeviceData?.telephoto != null)
                  _SensorTypeButton(
                    zoomFactor: _sensorDeviceData!.telephoto!.zoomFactor,
    ...
    return AwesomeOrientedWidget(
      child: AwesomeBouncingWidget(
        ...
        child: AnimatedContainer(
          ...
          child: Center(
            child: Text(
              '${zoomFactor?.toStringAsFixed(1) ?? ''}${isSelected ? 'x' : ''}',
              maxLines: 1,
              style: TextStyle(
